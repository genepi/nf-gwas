...
```
nextflow run genepi/gwas-regenie -r v0.2.0 -profile test,docker -bg
```
...
- Error: `Cannot find revision 'v0.2.0'` -- Make sure that it exists in the remote repository `https://github.com/genepi/gwas-regenie`
