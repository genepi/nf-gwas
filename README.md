...
```
nextflow run genepi/gwas-regenie -r v0.2.0 -profile test,<docker,singularity,slurm,slurm_with_scratch>
```

3) Run the pipeline on your data

```
nextflow run genepi/gwas-regenie -c <nextflow.config> -r v0.2.0 -profile <docker,singularity,slurm,slurm_with_scratch>
```
...
## Status
The pipeline is currently under development (v0.2.0).
