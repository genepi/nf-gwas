...
## Status
The pipeline is currently under development (v0.1.11).
...
```
nextflow run genepi/gwas-regenie -r v0.1.11 -profile test,<docker,singularity>
```

3) Run the pipeline on your data

```
nextflow run genepi/gwas-regenie -c <nextflow.config> -r v0.1.11 -profile <docker,singularity>
```
