...
```
nextflow run genepi/nf-gwas -r v0.4.0 -profile test,<docker,singularity,slurm,slurm_with_scratch>
```

3) Run the pipeline on your data

```
nextflow run genepi/nf-gwas -c <nextflow.config> -r v0.4.0 -profile <docker,singularity,slurm,slurm_with_scratch>
```
