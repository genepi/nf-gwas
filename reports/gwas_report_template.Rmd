...
params:
  ...
  date: 2021-08-09
  version: v0.0.1
  regenie_merged: ../tests/output/test-gwas/regenie_results/test-gwas.Y1.regenie.unfiltered.gz
  regenie_filename: test-gwas.Y1.regenie.gz
  phenotype: Y1
  covariates:
  phenotype_file: ../tests/input/phenotype.txt
  regenie_step1_log: ../tests/output/test-gwas/regenie_logs/test-gwas.step1.log
  regenie_step2_log: ../tests/output/test-gwas/regenie_logs/test-gwas.step2.log
---
