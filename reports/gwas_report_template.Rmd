...
annotatedTopHits <- fread(params$annotated_tophits_filename, select = c("CHROM", "GENPOS", "GENE_NAME"), header=TRUE, tmpdir="$PWD")

#merge gene names of tophits to regenieTable
regenieTable_annotated <- left_join(regenieTable, annotatedTopHits,  by = c("CHROM", "GENPOS"))
